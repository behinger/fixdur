    ...
    try:
        ...
        if current_trial[0][1] == 'seq':
            ...
            for subtrial in current_trial:
                ...
                used_bubble, more_bubbles = trial.get_image(subtrial_num,surf,bubble_image,all_bubbles,loaded_bubbles,remaining_bubbles,chosen_bubble,num_of_bubbles,dist_mat)                
                ...
                rects1 = [pygame.Rect(400,500,154,154)]
                rects1.append(pygame.Rect(800,500,154,154))
                ...
                pygame.time.delay(1)
                p.setData(int(0))
                pygame.display.update(rects1) # blit the currently fixated bubbles and all to be displayed bubbles.
                p.setData(int(25))
                pygame.time.delay(1)
                p.setData(int(0))
        ...
        print sys.exc_info()
        error_file = open(path_to_fixdur_code+'data/'+str(subject)+'/error_'+str(trial_num),'w')
        error_file.write("error: %s \n bubblenum: %i \n" %(sys.exc_info()[0],subtrial))
        error_file.close()
