...
def get_image(subtrial_num,surf,bubble_image,all_bubbles,loaded_bubbles,remaining_bubbles,chosen_bubble,num_of_bubbles,dist_mat):
    #empty background
    #image = grayimage
    ...
    if (np.mod(subtrial_num,2) == 1):
        surf.blit(current_bubble,(400,500))
    else:
        surf.blit(current_bubble,(800,500))
    more_bubbles = True
    if num_of_bubbles > 1:
