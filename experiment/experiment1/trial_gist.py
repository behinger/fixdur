...
def training(surf,el,memory_image,fix_cross):
    ...
    for bubble_image in training_images:   
        ...
        if bubble_image == 'image_28.bmp':
            stim = pygame.image.load(path_to_fixdur_files+'stimuli/noise/'+bubble_image).convert()    
